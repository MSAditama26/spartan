                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <img src="<?= base_url('assets/img/logo_bps.png'); ?>" style="width:20%;" alt="logo">
                                    <br>
                                    <br>
                                    <h1 style="color:black; font-weight: bold;">SPARTAN</h1>
                                    <p style="color:black;">SISTEM PENILAIAN KINERJA MITRA NUNUKAN</p>
                                </div>
