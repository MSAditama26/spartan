        ...
        <div class="col-lg-10" style="color:#00264d;">
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="posisi" name="posisi" value="<?= $mitra['posisi']; ?>" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="<?= $mitra['kecamatan']; ?>" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="desa" name="desa" value="<?= $mitra['desa']; ?>" readonly>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="sobat_id" name="sobat_id" value="<?= $mitra['sobat_id']; ?>" readonly>
