...
class Kegiatan extends CI_Controller
{
    ...
    function pengawasterpilih($kegiatan_id)
    {
        ...
        $sqlpengawas = "SELECT pegawai.id_peg as id_peg, pegawai.email as email, pegawai.nama as nama FROM all_kegiatan_pengawas JOIN pegawai ON all_kegiatan_pengawas.id_pengawas = pegawai.id_peg WHERE all_kegiatan_pengawas.kegiatan_id = $kegiatan_id UNION (SELECT mitra.id_mitra as id_peg, mitra.email as email, mitra.nama as nama FROM all_kegiatan_pengawas JOIN mitra ON all_kegiatan_pengawas.id_pengawas = mitra.id_mitra WHERE all_kegiatan_pengawas.kegiatan_id = $kegiatan_id)";
